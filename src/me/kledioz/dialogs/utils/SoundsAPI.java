...
/*
 * Autor: No se de quien lo saque xd
 */
...
public enum SoundsAPI {
	...
	SoundsAPI(String... versionDependentNames) {
		this.versionDependentNames = versionDependentNames;
	}

	public static Sound getSound(String snd) {
		for (SoundsAPI snds : SoundsAPI.values()) {
			for (String str : snds.versionDependentNames) {
				if (str.equalsIgnoreCase(snd)) {
					return snds.bukkitSound();
				}
			}
		}
		return null;
